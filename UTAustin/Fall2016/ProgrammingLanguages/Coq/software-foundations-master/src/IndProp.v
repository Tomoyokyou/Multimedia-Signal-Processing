...
Add LoadPath "/Users/AhPan/Documents/git/UTAustin/Fall2016/ProgrammingLanguages/Coq/software-foundations-master/src".
...
Proof.
  ...
  {
    intros E.
    induction E as [|n1 E1 IH1| n2 E2 IH2].
    - apply ev_0.
  ...
  {
    intros E.
    induction E as [|n1 E1 IH1].
    - apply ev'_0.
    - destruct n1 eqn:DesN1.
      + apply ev'_2.
      +
         assert (I : forall n, n+2 = S(S n)).
        { intros n0.
          induction n0.
          -  reflexivity.
...
Proof.
  ...
  - simpl in H0. inversion H0. apply IHev in H2. apply H2. 
Qed.
